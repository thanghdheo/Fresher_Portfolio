...
function Portfolio() {
  const projects = [
    ...
    },
    {
      ...
      tech: " ReactJs Hook, React toolkit, Material UI, Sanity, React Reveal, Styled Components, React Slick, React Spinners, Axios , React hook form, Sweet Aleart ",
    ...
    },
    {
      ...
      func: "Integrated API, Show list product with pagination, Filter/Search, Add product, Export products to excel file, Export products by date range to excel file ",
